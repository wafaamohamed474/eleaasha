  ...
  return (
    <>
      ...
      <Sidebar
        ...
        collapsible="icon"
        className="md:hidden lg:flex border-e border-(--secondary-foreground)/10 bg-white shadow-xl shadow-(--secondary-foreground)/5"
      >
        {/* -------- Content -------- */}
...
function MobileTabs({ items, t, locale, pathname }: any) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/80 backdrop-blur shadow-sm pb-safe-area-inset-bottom">
      <nav className="flex items-center justify-around md:justify-center h-16 px-2">
        {items.map((item: any) => {
